...
window.VIDEO_REGISTRY = {
  ...
  'w-4:2': { id:'hxhbOvR2TGk', channel:'CrashCourse',
    ...
    note:'ID verified 2026-07-24 (resolves, title match). Approved + signed by KoKo, 2026-07-24.' },
  ...
  'o-w-2:3': { id:'rwbho0CgEAE', channel:'Technology for Teachers and Students',
    ...
    review:'approved', cco:'signed', recheck:'2026-10-24', twin:'brief',
    note:'ID verified 2026-07-24 (resolves, title match). Visual-first; MM dubbing/subtitling stays on the Phase 2 lane. Approved + signed by KoKo, 2026-07-24.' },
